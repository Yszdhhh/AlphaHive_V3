# RESEARCHJOB-FIRST-MANUAL-EVIDENCE-GROK-001

**task_id:** `RESEARCHJOB-FIRST-MANUAL-EVIDENCE-GROK-001`  
...
**exact evidence output:** `C:\\Users\\10639\\Desktop\\AlphaHive_V3_A_DATA_HEALTH_deliverables\\agent_outputs\\grok\\RESEARCHJOB-FIRST-MANUAL-EVIDENCE-GROK-001.json`  
**exact PARK report output (only if no admissible evidence exists or browsing is unavailable):** `C:\\Users\\10639\\Desktop\\AlphaHive_V3_A_DATA_HEALTH_deliverables\\agent_outputs\\grok\\RESEARCHJOB-FIRST-MANUAL-EVIDENCE-GROK-001-PARK.md`
...
6. If no admissible source can be proven cutoff-safe, or the browsing capability
   is unavailable, do not write a JSON bundle. Write the exact PARK Markdown
   report instead. State whether the cause was missing cutoff-safe evidence or
   unavailable browsing, list every attempted/rejected source if any, and do
   not guess or use another output path.
