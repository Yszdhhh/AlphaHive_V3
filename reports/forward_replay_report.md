...
- 生成: 2026-08-11 00:35 UTC
- 候选源: contract_monitor_candidates.csv（n=1），trigger=['cvd_bear_divergence']）
...
| 组 | n | 均值% | 中位数% | 胜率% |
|---|---|---|---|---|
| candidate | 1 | -0.45 | -0.45 | 0 |
| baseline | 157 | -0.61 | -0.55 | 24 |

超额（事件−基线）均值 = +0.16%  bootstrap 95% CI [+0.01, +0.31]

> ⚠️ 样本不足（事件 n=1，基线 n=157）→ PENDING，继续积累前向影子。
...
|---|---|---|---|---|---|---|
| 1 | 08-10 21:00~08-10 21:00 | 0 | - | - | - ~ - | 无基线 |
