# S1 挑战者：FAM-001 冻结（214，一次时间 holdout）

- 生成：2026-08-09 11:59 UTC
...
| 形态 | IC | uplift | n |
|---|---|---:|---:|
| capped_hinge(1,2) | +0.130 | +2.56% | 1078 |
| log_ratio | +0.131 | +2.81% | 899 |

## holdout 一次评估（选中形态）

| 形态 | IC | uplift | 6h 聚类 CI | n | 判定 |
|---|---|---:|---:|---:|---|
| log_ratio | +0.053 | +0.30% | [-1.82, +5.83] | 91 | **NO_GO/UNDERPOWERED** |
